...
### Quick Links
 - Frontend Repo    : https://github.com/ratulshah12/event-manegement-fontend-.git
- Backend Repo     : https://github.com/ratulshah12/backend-event-mamagement-system.git
- Frontend Live    : https://event-manegement-platform.vercel.app/
- Backend Live     : https://nextlevel-backend-assignment-5-psi.vercel.app/
...
## Setup Instructions
- (frontend) : git clone https://github.com/ratulshah12/event-manegement-fontend-.git
- (backend) : git clone https://github.com/ratulshah12/backend-event-mamagement-system.git

### Backend Setup
- cd backend-event-mamagement-system
- pnpm install
- Create .env file:
```typescript
